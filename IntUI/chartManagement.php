<?php
	...
	// Page PHP Backend Code Begin
		...
		foreach($allCharts as $arr) {
			...
			$chartHtml .= '	<td class="options" style="width:130px;"><a href="createChart1.php?chartId='.$arr['chartId'].'" title="Modify Chart"><span class="ui-icon ui-icon-pencil"></span></a><a href="chartPermission.php?chartId='.$arr['chartId'].'" title="Modify Chart Permissions"><span class="ui-icon ui-icon-locked"></span></a><a title="Delete Chart" id="delete-chart"><span class="ui-icon ui-icon-trash"></span></a></td>';
